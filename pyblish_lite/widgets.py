...
class PerspectiveWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent):
        ...
        traceback = ExpandableWidget(self, self.l_traceback)
        traceback_label = PerspectiveLabel()
        traceback.set_content(traceback_label)
        layout.addWidget(traceback)
    ...
    def set_context(self, index):
        ...
        if index_type == model.InstanceType:
            ...
            # Traceback is untoggled by default
            traceback = index.data(Roles.TracebackModuleRole) or ""
            self.traceback.content.setText(traceback)
