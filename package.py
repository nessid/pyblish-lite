...
def commands():
    ...
    env.PYBLISH_PLUGINS_SETTINGS_BY_TASKS_JSON = '{root}/pyblish_config/pyblish_plugins_settings_by_tasks.json'
    # Path to the JSON file listing production assets types and their associated tasks
    env.PYBLISH_ASSET_TASKS_MAPPING_JSON = '{root}/pyblish_config/asset_tasks_mapping.json'
